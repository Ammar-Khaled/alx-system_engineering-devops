# Web server
This project was done during **Software Engineering studies** at **ALX School**. It aims to learn about the roles of web servers and their processes (parent and child), and DNS roles.
